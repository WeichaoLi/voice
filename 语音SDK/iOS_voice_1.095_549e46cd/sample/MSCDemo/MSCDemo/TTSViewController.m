...
- (void) onStart:(id) sender
{
    if (_state == NotStart)
    {
        ...
        [_iFlySpeechSynthesizer startSpeaking:[_toBeSynthersedTextView.text stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceCharacterSet]]];
...
-(void)onSynthesizeToUri:(id)sender
{
    if (_state == NotStart)
    {
        ...
        [_iFlySpeechSynthesizer  synthesize: [_toBeSynthersedTextView.text stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceCharacterSet]] toUri:nil];
